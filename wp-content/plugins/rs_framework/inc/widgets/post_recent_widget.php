...
function wpb_load_widget() {
    register_widget( 'finoptis_recent_widget' );
}
add_action( 'widgets_init', 'wpb_load_widget' );
 
// Creating the widget 
class finoptis_recent_widget extends WP_Widget {
...
__('Finoptis Recent Post Widget', 'finoptis'), 
 
// Widget description
array( 'description' => __( 'Recent post widget with different options', 'finoptis' ), ) 
);
}
...
if ( ! isset( $args['widget_id'] ) ) {
		...
		$title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : __( 'Recent Posts','finoptis' );
...
<p>
  <label for="<?php echo esc_attr($this->get_field_id( 'number' )); ?>">
    <?php esc_html_e( 'Number of posts to show:','finoptis' ); ?>
  </label>
...
<p>
  ...
  <label for="<?php echo esc_attr($this->get_field_id( 'show_date' )); ?>">
    <?php esc_html_e( 'Display post date?','finoptis' ); ?>
  </label>
</p>
<p>
  ...
  <label for="<?php echo esc_attr($this->get_field_id( 'show_featured_image' )); ?>">
    <?php esc_html_e( 'Display featured image?','finoptis' ); ?>
  </label>
</p>
<?php
	}
