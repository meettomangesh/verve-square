...
function finoptis_contact_widget() {
    register_widget( 'contact_widget' );
}
add_action( 'widgets_init', 'finoptis_contact_widget' );
...
class contact_widget extends WP_Widget {
   ...
   function __construct() {
    parent::__construct(
      'contact_widget', 
      __('Finoptis Contact Info', 'finoptis'),
      array( 'description' => __( 'Display your contact info!', 'finoptis' ), )
    );
  }
  ...
  <ul class="fa-ul">
    ...
    if( $image_src != '' ){?>
         <li class="about-widget-img">
          <?php if($instance['url']){?>
              <a  href='<?php echo esc_url($instance['url']);?>'><img alt="<?php esc_html_e('image','finoptis');?>" src="<?php echo esc_url($image_src[0]);?>"></a>
          <?php } else {?>
              <img alt="<?php esc_html_e('image','finoptis');?>" src="<?php echo esc_url($image_src[0]);?>">
          <?php } ?>
            </li>
      <?php } 
  ...
  function update($new_instance, $old_instance) {   
    ...
    function form($instance) {  
     ...
     ?>
        ...
        <p>
          <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title:', 'finoptis'); ?></label> 
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('image')); ?>"><?php esc_html_e('Image:','finoptis'); ?></label>
            <br/>
            ...
            <input type="button" class="button btn-primary widgetuploader" value="<?php esc_html_e('Add Image','finoptis'); ?>" />
        </p>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('url')); ?>"><?php esc_html_e('Target URL:','finoptis'); ?></label>
            <br/>
        ...
        <p>
          <label for="<?php echo esc_attr($this->get_field_id('address')); ?>"><?php esc_html_e('Address:', 'finoptis'); ?></label> 
        ...
        <p>
          <label for="<?php echo esc_attr($this->get_field_id('phone')); ?>"><?php esc_html_e('Phone:', 'finoptis'); ?></label> 
        ...
        <p>
          <label for="<?php echo esc_attr($this->get_field_id('email')); ?>"><?php esc_html_e('Email:', 'finoptis'); ?></label> 
        ...
        <p>
          <label for="<?php echo esc_attr($this->get_field_id('app')); ?>"><?php esc_html_e('WhatsApp:', 'finoptis'); ?></label> 
        ...
        <p>
          <label for="<?php echo esc_attr($this->get_field_id('fax')); ?>"><?php esc_html_e('Fax:', 'finoptis'); ?></label> 
        ...
        <p>
          <label for="<?php echo esc_attr($this->get_field_id('hour')); ?>"><?php esc_html_e('Opening Hour:', 'finoptis'); ?></label> 
