...
function rs_service_register_post_type() {
	...
	global $rs_option;
	$service_slug = (!empty($rs_option['service_slug']))? $rs_option['service_slug'] :'service';
	$args = array(
		'labels'             => $labels,
		'public'             => true,
...
function tr_create_service() {
	global $rs_option;
	$service_slug_cat = (!empty($rs_option['service_slug']))? $rs_option['service_slug'].'-category' :'service-category';
	register_taxonomy(
		'service-category',
		'services',
		array(
