...
<div class="services-main rs-services-style4  services-<?php echo $align; ?> <?php echo $css_class; ?> <?php echo $css_class_custom; ?>" <?php echo $border_color; ?> data-icon-hover="<?php echo $icon_hover_color;?>" data-icon-hoverbg="<?php echo $icon_hover_bg;?>" data-icon-bg="<?php echo $service_icon_bg;?>" data-icon-color="<?php echo $icon_color_normal;?>">
	<?php if ($imgSrc) { ?>
	...
	<div class="services-item">
		...
		<div class="services-desc" <?php echo $desc_bg; ?>>
			<h4 class="services-title"><a <?php echo $attributes; ?> style="<?php echo $title_css; ?>" data-onhovercolor="<?php echo $title_hovercolor;?>" data-onleavecolor="<?php echo $title_color;?>"> <?php echo $title; ?> </a></h4>
