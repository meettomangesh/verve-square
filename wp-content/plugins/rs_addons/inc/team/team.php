...
function rs_team_register_post_type() {
	...
	$team_slug = (!empty($finoptis_option['team_slug']))? $finoptis_option['team_slug'] :'teams';
	$args = array(
		'labels'             => $labels,
		'public'             => true,
...
function tr_create_team() {
	global $finoptis_option;
	$team_slug_cat = (!empty($finoptis_option['team_slug']))? $finoptis_option['team_slug'].'-category' :'team-category';
	register_taxonomy(
		'team-category',
		'teams',
		array(
