...
function finoptis_import_files() {
  return array(
    ...
    array(
     ...
     'import_notice'              => __( 'Caution: For importing demo data please click on "Import Demo Data" button. During demo data installation please do not refresh the page.', 'finoptis' ),
